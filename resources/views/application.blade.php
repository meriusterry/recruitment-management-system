        ...
        <main class="flex-1 p-0">
            <div class="bg-white dark:bg-white overflow-hidden shadow-sm">
                <div class="p-4 text-gray-900 dark:text-gray-100">
                                ...
                                <thead class="bg-gray-100 text-gray-900">
                                    <tr>
                                      ...
                                      <th class="px-4 py-2 font-medium">Id</th>
                                        <th class="px-4 py-2 font-medium">Vacancy Tittle</th>
                    ...
                    <!-- Modal (absolutely positioned on top of everything) -->
                    <div
                    x-show="open"
                    x-transition
                ...
                >
                    <div @click.away="open = false"
                        ...
                        <div class="absolute top-0 left-0 w-full h-6 bg-gradient-to-b from-white/70 to-transparent pointer-events-none rounded-t-lg z-10"></div>
                            ...
                            <div class="flex justify-between items-center mb-4">
                                <h2 class="text-xl font-bold text-gray-700">Create Vacancy</h2>
                            ...
                            <form action="{{ route('vacancies.store') }}" method="POST">
                                ...
                                <div class="grid grid-cols-2 gap-4 mb-4 ">
                                    <div>
                                        ...
                                        <input type="text" name="job_title" class="mt-1 block w-full border  p-2" required>
                                    </div>
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700">Location</label>
                                        <input type="text" name="location" class="mt-1 block w-full border  p-2" required>
                                    </div>
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700">Salary Rate</label>
                                        <input type="number" name="salary_rate" class="mt-1 block w-full border  p-2" required>
                                    </div>
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700">Closing Date</label>
                                        <input type="date" name="closing_date" class="mt-1 block w-full border  p-2" required>
                                    </div>
                                </div>
  
                                <div class="mb-4">
                                    <label class="block text-sm font-medium text-gray-700">Job Description</label>
                                    <textarea name="job_description" rows="3" class="mt-1 block w-full border  p-2" required></textarea>
                                </div>
                                <div class="mb-4">
                                    <label class="block text-sm font-medium text-gray-700">Requirements</label>
                                    <textarea name="requirements" rows="2" class="mt-1 block w-full border  p-2" required></textarea>
                                </div>
